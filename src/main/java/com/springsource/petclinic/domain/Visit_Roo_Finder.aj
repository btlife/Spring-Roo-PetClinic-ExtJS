...
privileged aspect Visit_Roo_Finder {
    ...
    public static TypedQuery<Visit> Visit.findVisitsByDescriptionAndVisitDate(String description, Date visitDate) {
        ...
        TypedQuery<Visit> q = em.createQuery("SELECT Visit FROM Visit AS visit WHERE visit.description = :description AND visit.visitDate = :visitDate", Visit.class);
    ...
    public static TypedQuery<Visit> Visit.findVisitsByVisitDateBetween(Date minVisitDate, Date maxVisitDate) {
        ...
        EntityManager em = Visit.entityManager();
        TypedQuery<Visit> q = em.createQuery("SELECT Visit FROM Visit AS visit WHERE visit.visitDate BETWEEN :minVisitDate AND :maxVisitDate", Visit.class);
    ...
    public static TypedQuery<Visit> Visit.findVisitsByDescriptionLike(String description) {
        ...
        EntityManager em = Visit.entityManager();
        TypedQuery<Visit> q = em.createQuery("SELECT Visit FROM Visit AS visit WHERE LOWER(visit.description) LIKE LOWER(:description)", Visit.class);
        q.setParameter("description", description);
        return q;
    }
